package SystemManage.Common.result;
...
public class CommonResults<T> implements Serializable {
    ...
    public static <T> CommonResults<T> success() {
        return new CommonResults<T>(ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getMessage());
    }
    ...
    public static <T> CommonResults<T> failure(String msg) {
        return new CommonResults<T>(500, msg);
    }
