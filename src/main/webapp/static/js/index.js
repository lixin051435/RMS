...
layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
    ...
    function showNotice() {
        layer.open({
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>本系统是通过前端技术layui + easyui集成写的，后端技术基于ssm框架，mysql数据库。</p>作者：黎锐洪<p><strong class="layui-red"></strong></p></div>',
