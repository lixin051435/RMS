            ...
            <div class="layui-elem-quote layui-quote-nm">
                <ul class="layui-timeline">
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            <div class="layui-timeline-title">
                                <h3 class="layui-inline">修改部分bug并完善其他功能后形成的CRM管理系统 V1.0.1发布　</h3>
                                <span class="layui-badge-rim">2020-02-22</span>
                            </div>
                            <ul>
                                <li># v1.0.1（优化） - 2020-02-22</li>
                    ...
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            <div class="layui-timeline-title">
                                <h3 class="layui-inline">CRM管理系统 V1.0</h3>
                                <span class="layui-badge-rim">2020-1-22</span>
                            </div>
                        </div>
                    </li>
