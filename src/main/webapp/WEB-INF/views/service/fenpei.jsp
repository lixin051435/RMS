    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_serveType" readonly value="${service.serveType}" name="serveType" required=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="servicerequest" readonly value="${service.servicerequest}" name="servicerequest"
                       required=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="createTime" readonly
                       value="<fmt:formatDate value="${service.createTime}" pattern="yyyy-MM-dd"/>" name="createTime"
                       required=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="assigner" for="assigner" value="${service.assigner}" name="assigner" lay-search="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="assignTime" value="${service.assignTime}" name="assignTime" required=""
                       lay-verify="css"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
