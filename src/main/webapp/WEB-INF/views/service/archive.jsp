...
<div class="x-body">
    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="createTime" readonly
                       value="<fmt:formatDate value="${service.createTime}" pattern="yyyy-MM-dd"/>"
        ...
        <div class="layui-form-item">
            <label for="serviceProceResult" class="layui-form-label">
                <span class="x-red"></span>服务处理结果
            </label>
            <div class="layui-input-inline">
                <input type="text" id="serviceProceResult" value="${service.serviceProceResult}"
                       name="serviceProceResult" required=""
                       lay-verify="serviceProceResult"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="myd" value="${service.myd}" name="myd" required=""
                       lay-verify="myd"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
