        ...
        $(function () {
            ...
            layui.use(['layer','form'], function(){
                var layer = layui.layer,
                    form = layui.form ;
                layer.alert('管理员账号：admin 密码：123', {
...
<div class="main layui-layout animated shake larry-delay2" id="larry_login" style="margin-top: 94px;">
    ...
    <div class="user-info">
        ...
        <form class="layui-form" id="login" method="post">
            <div class="layui-form-item">
                ...
                <input type="text" name="username" style="ime-mode:disabled" required lay-verify="required" aautocomplete="off" value="admin" class="layui-input larry-input" placeholder="请输入账号" autocomplete="off">
            </div>
            <div class="layui-form-item" id="password">
                <label class="layui-form-label">密码:</label>
                <input type="password" name="password" style="ime-mode:disabled" required lay-verify="required|password" value="123" aautocomplete="off" class="layui-input larry-input" placeholder="请输入密码" autocomplete="off">
            </div>
    ...
    <div class="copy-right"><span style="color:white">Background Management System Design by 黎锐洪</span></div>
</div>
</body>
</html>